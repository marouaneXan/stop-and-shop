                                                        ...
                                                        <div class="modal-body">
                                                            <form>
                                                                <div class="mb-1">
                                                                    ...
                                                                    <label for="formFile" class="form-label">Image</label>
                                                                    <input type="file" multiple class="form-control" @change="ImageName" id="formFile" enctype='multipart/form-data' required>
                                                                    <label class="form-label">Select Category</label>
                                                                    <select class="form-select" v-model="product.id_category" aria-label="Default select example" required>
                                                                        <option disabled selected>Select Category</option>
                                                                        <option v-for="c in categories" :key="c.id_cat" :value="c.id_cat">{{c.nom_cat}}</option>
                                                                    </select>
                                                                    <label for="Quantity" class="form-label">Quantity</label>
                                                                    <input type="number" v-model="product.quantite" required class="form-control" id="Quantity">
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
