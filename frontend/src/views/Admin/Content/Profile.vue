                    ...
                    <div class="card mb-3" style="border-radius: .5rem;width: 600px;">
                        <div class="row g-0">
                            <div class="col-md-4 gradient-custom text-center text-white" style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
                                ...
                                <p>Web Designer</p>
                                <div @click="passingDataUpdate(AdminInfos)">

                                    <i class="far fa-edit mb-5" data-bs-toggle="modal" data-bs-target="#updateProduct" style="cursor:pointer"></i>
                                </div>
    ...
    methods: {
        ...
        async UpdateDataAdmin() {
            ...
            if (res.data.message == "Your informations Updated successfully") {
                ...
                this.fetchDataAdmin()
                this.UpdatedataAdmin.error = "Error on Updating Profile information";
            }
        },
    },
}
